...
/**
 * Model for configured CSAF provider entities.
 *
 *
...
public class CsafProviderEntity implements Serializable {
    ...
    public CsafProviderEntity() {
        // no args for jdo
    }

    public CsafProviderEntity(String name, String url) {
        this.name = name;
        this.url = url;
    }
